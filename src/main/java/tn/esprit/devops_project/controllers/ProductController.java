...
public class ProductController {
    ...
    @PutMapping("/product/{idStock}")
    Product updateProduct(@RequestBody Product product,@PathVariable Long idStock)
    {
        return productService.updateProduct(product , idStock);
    }
}
